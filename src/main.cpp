...
const int I2C_BME280_ADDRESS = 0x76; // Default I2C address for BME280. can be changed to 0x76 by changing a solder bridge
...
void setup()
{
  ...
  // NON DOVREBBE SERVIRE: https://randomnerdtutorials.com/esp8266-bme280-arduino-ide/
  // usando i default:
...
* NAN and isnan per i numeri non inizializzati
...
* temp, humiidty, pressure calculation:
